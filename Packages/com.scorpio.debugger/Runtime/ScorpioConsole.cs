...
public class DebugLogEntry {
    ...
    public string LogString => logString.Length > ScorpioConsole.LogStringMaxLength ? logString.Substring(0, ScorpioConsole.LogStringMaxLength) : logString;
    public string StackTrace => stackTrace.Length > ScorpioConsole.StackTraceMaxLength ? stackTrace.Substring(0, ScorpioConsole.StackTraceMaxLength) : stackTrace;
...
public class ScorpioConsole {
    ...
    public static ScorpioConsole Instance { get; } = new ScorpioConsole();      //单例
