...
namespace UnityEngine.UI
{
    ...
    [UnityEditor.CustomEditor(typeof(SlicedFilledImage))]
    public class SlicedFilledImageEditor : UnityEditor.Editor
    {
        private UnityEditor.SerializedProperty spriteProp, colorProp;
        ...
        public override void OnInspectorGUI()
        {
            ...
            UnityEditor.EditorGUILayout.PropertyField(spriteProp, spriteLabel);
            UnityEditor.EditorGUILayout.PropertyField(colorProp);
