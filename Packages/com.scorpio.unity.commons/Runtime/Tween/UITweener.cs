...
{
	public OnFinished<UITweener> onFinished;
	...
	public Direction direction { get { return mAmountPerDelta < 0f ? Direction.Reverse : Direction.Forward; } }
	...
	/// </summary>
	static public UITweener Begin(UnityEngine.Object obj) {
		var comp = EngineUtil.GetComponent<UITweener>(obj, false);
	...
	static public T Begin<T> (UnityEngine.Object obj, float duration) where T : UITweener
	{
        var comp = EngineUtil.GetComponent<T>(obj, false);
		if (comp == null) {
            comp = EngineUtil.AddComponent<T>(obj);
